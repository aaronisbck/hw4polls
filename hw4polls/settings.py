"""
Django settings for hw4polls project.
...
#
#  heroku config:set DJANGO_SECRET_KEY='_6^wbunj6y4w+92x-r5*x3959s%f15992e0tv*@v^x^9(v=pbb'
# 
# and then read the secret key from the environment variable with:
#  SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY')
#
SECRET_KEY = '_6^wbunj6y4w+92x-r5*x3959s%f15992e0tv*@v^x^9(v=pbb'
...
ROOT_URLCONF = 'hw4polls.urls'

# WSGI configuration
# See https://docs.djangoproject.com/en/1.7/howto/deployment/wsgi/
WSGI_APPLICATION = 'hw4polls.wsgi.application'

# Database
# https://docs.djangoproject.com/en/1.7/ref/settings/#databases
# Parse database configuration from DATABASE_URL using dj-database-url
# if the environment variable is not defined then default to hw4polls_db.sqlite3.
...
DATABASES = {
    "default": dj_database_url.config(default="sqlite:///"+os.path.join(BASE_DIR, 'hw4polls_db.sqlite3')),
}
